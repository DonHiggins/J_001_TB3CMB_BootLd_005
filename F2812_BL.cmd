...
PAGE 0:    /* Program Memory */
   ...
   FLASHC      : origin = 0x3F0000, length = 0x004000     /* on-chip FLASH -- combine FLASHC,FLASHD*/
   VEC_FROM_MAIN : origin = 0x3F4000, length = 0x000004     /* Fixed loc vector, main prog jumps to start bootloader*/
   FLASHAB     : origin = 0x3F4004, length = 0x003F7C     /* Combine FLASHA & B for bootloader, minus 4 words*/
...
SECTIONS
{
   /* Allocate program areas: */
    bootentry          : > VEC_FROM_MAIN         PAGE = 0
   /* For Bootloader reserve FLASHA + FLASHB 0x4000 words                             */
   /* For main program use FLASH C,D,E, etc                                           */
